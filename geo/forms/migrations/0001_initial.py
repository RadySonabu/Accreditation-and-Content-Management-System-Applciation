    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criteria', models.CharField(max_length=150)),
                ('points', models.FloatField()),
                ('subdivision_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forms.SubdivisionDetail')),
            ],
        ),
        migrations.CreateModel(
            name='Forms',
        ...
        migrations.AddField(
            model_name='division',
            name='subdivision',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forms.Subdivision'),
        ),
        migrations.AddField(
            model_name='division',
            name='subdivision_detail',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forms.SubdivisionDetail'),
        ),
        migrations.CreateModel(
            name='BasicInfo',
            fields=[
